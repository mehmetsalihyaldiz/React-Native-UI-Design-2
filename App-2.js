    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ backgroundColor: 'yellow', flex: 1.6 }}>
        ...
        <View style={{ width, position: 'absolute', bottom: -20, overflow: 'visible', zIndex: 999, justifyContent: 'center', alignItems: 'center' }}>
          <Text style={{ color: '#000000', fontSize: 15, backgroundColor: '#FFCC35', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 50 }} >Women</Text>
        </View>
        <View style={{ position: 'absolute', right: 15, top: 15 }}>
          <View style={{ flexDirection: 'row', marginTop: 5 }}>
            <TouchableOpacity style={{ marginRight: 10, }} onPress={() => { console.log('favorite clicked'); }}>
              <View style={{ backgroundColor: '#A5A4A2', padding: 10, borderRadius: 50 }}>
                <Icon name="heart" size={20} color={"#000000"} />
              </View>
            </TouchableOpacity>
            <TouchableOpacity style={{}} onPress={() => { console.log('favorite clicked'); }}>
              <View style={{ backgroundColor: '#A5A4A2', padding: 10, borderRadius: 50 }}>
                <Icon name="shopping-basket" size={20} color={"#000000"} />
              </View>
            </TouchableOpacity>
          </View>
        </View>
      ...
      <View style={{ flex: 1 }}>
        <View style={{ marginTop: 25, width: width, justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ justifyContent: 'center', alignItems: 'center', width: width / 1.5 }}>
            <Text style={{ fontSize: 36, lineHeight: 30, paddingTop: 15, fontWeight: 'bold', color: '#2C2C2C', textAlign: 'center' }}>{"Midi bodycon dress"}</Text>
          </View>
        </View>
        <View style={{ marginTop: 7.5, justifyContent: 'center', alignItems: 'center' }}>
          <Text style={{ fontSize: 25, color: '#000000' }}>{"£154.00-£195.00"}</Text>
        </View>
